...
function Footer() {
  return (
    <>
      <footer className="footer bg-background text-foreground p-10 dark:bg-background dark:text-foreground">
        <nav>
      ...
      <footer className="footer bg-background text-foreground border-t border-border px-10 py-4 dark:bg-background dark:text-foreground">
        <aside className="grid-flow-col items-center">
          ...
          <p>
            Sole Arcade
            <br />
            Your trusted online shoe store since 2023
          </p>
        </aside>
